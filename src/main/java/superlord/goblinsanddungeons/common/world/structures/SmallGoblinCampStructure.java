...
public class SmallGoblinCampStructure extends Structure {

	public static final Codec<SmallGoblinCampStructure> CODEC = simpleCodec(SmallGoblinCampStructure::new);
	
	public SmallGoblinCampStructure(Structure.StructureSettings settings) {
		super(settings);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_197233_, GenerationContext p_197234_) {
		...
		SmallGoblinCampStructurePiece.addStructure(p_197234_.structureTemplateManager(), blockpos, rotation, p_197233_, p_197234_.random());
	}
	...
	public StructureType<?> type() {
		return StructureInit.SMALL_GOBLIN_CAMP.get();
	}
}