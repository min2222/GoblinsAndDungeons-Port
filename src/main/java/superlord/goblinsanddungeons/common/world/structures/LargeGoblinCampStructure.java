...
public class LargeGoblinCampStructure extends Structure {

	public static final Codec<LargeGoblinCampStructure> CODEC = simpleCodec(LargeGoblinCampStructure::new);
	
	public LargeGoblinCampStructure(Structure.StructureSettings settings) {
		super(settings);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_197233_, GenerationContext p_197234_) {
		...
		LargeGoblinCampStructurePiece.addStructure(p_197234_.structureTemplateManager(), blockpos, rotation, p_197233_, p_197234_.random());
	}
	...
	public StructureType<?> type() {
		return StructureInit.LARGE_GOBLIN_CAMP.get();
	}
}